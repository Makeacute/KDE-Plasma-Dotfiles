...
This collection includes two variants of the Starship prompt, both customized for a **high-contrast, monochrome (grayscale)** aesthetic.
...
This is what the Starship terminal prompt looks like using the **Dark → Light# KDE Plasma Dotfiles
...
* **Starship Presets:** These monochrome presets are modifications of the official **Catppuccin Powerline preset** for Starship.
    * **Original Preset Source:** [Starship Catppuccin Powerline](https://starship.rs/presets/catppuccin-powerline)** configuration:
